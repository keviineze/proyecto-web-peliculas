...
*(Describe de forma concreta y detallada la tarea que vas a realizar en esta entrega. Si vas a generar código, diseñar un mockup o documentar prompts, explicalo aquí).*

## 2. ¿Por qué es necesario?
*(Justifica cómo esta tarea aporta valor al "Mini Letterboxd" y de qué manera responde a los requerimientos funcionales y objetivos definidos en el archivo maestro plan.md).*
