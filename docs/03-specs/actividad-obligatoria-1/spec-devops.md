# Especificación Técnica: Configuración Inicial y DevOps
**Rol:** Coordinador / DevOps  
**Entrega:** Actividad Obligatoria N° 1  

## 1. Qué se hará
- Creación y configuración del repositorio en GitHub para el proyecto de la aplicación web tipo "Mini Letterboxd".
- Configuración de las ramas principales `master` y `develop` con reglas de protección estrictas (bloqueo de push directo y requerimiento de al menos un revisor/PR).
- Generación del archivo maestro `plan.md` en la raíz utilizando GitHub Copilot en modo Agente para extraer y estructurar los requerimientos funcionales del simulador consensuado por el equipo.
- Creación de la estructura de directorios inicial (`/css`, `/js`, `docs/specs/`, `.github/`).
