...
El Spec-Driven Development (SDD) es una metodología de trabajo que exige que cada tarea sea especificada antes de ser ejecutada. Utilizamos SDD para garantizar que el trabajo de cada rol esté alineado estrictamente con los requerimientos funcionales del archivo maestro plan.md.
...
Verificamos que todos los integrantes del equipo cuentan con las herramientas obligatorias instaladas y operativas:
