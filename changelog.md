...
- [feature/frontend-add-html-structure] Agregado de spec-frontend.md 
  PR: [#4](https://github.com/keviineze/proyecto-web-peliculas/pull/4) - @GonzaloBarbano (Desarrollo front-end)

- [feature/doc-ux-add-readme-and-mockup] Agregado de spec-ux.md y de README.md 
  PR: [#3](https://github.com/keviineze/proyecto-web-peliculas/pull/3) - @GonzaloBarbano (Documentador/UX)
